    ...
    return (
        <div className="space-y-6">
            ...
            <BentoGrid>
                ...
                <div className="md:col-span-2 md:row-span-2 glass-card gradient-border p-6 rounded-xl flex flex-col">
                    <div className="flex items-center justify-between mb-6">
                        <h3 className="text-lg font-semibold text-white">System Growth</h3>
                        <TrendingUp className="h-5 w-5 text-indigo-400" />
                    </div>
                    <div className="flex-1 flex items-center justify-center border border-dashed border-zinc-700 rounded-lg bg-black/30">
                        <p className="text-zinc-400 text-sm">Growth Chart Placeholder (Recharts)</p>
                    </div>
                </div>

                {/* Recent Users List */}
                <div className="md:col-span-2 glass-card gradient-border p-6 rounded-xl">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-sm font-medium text-zinc-300">Recent Users</h3>
                        <UserPlus className="h-4 w-4 text-indigo-400/70" />
                    </div>
